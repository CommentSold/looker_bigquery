view: qa_ai_echo_me {
  ...
  derived_table: {
    sql:
      ...
      COUNTIF(sea_status = 'active') AS total_sea_active,
      COUNTIF(coda_status = 'active') AS total_coda_active,
      COUNTIF(dma_status = 'active') AS total_dma_active,
      COUNTIF(asa_status = 'active') AS total_asa_active,
      COUNTIF(raca_status = 'active') AS total_raca_active,
      -- Count rows where at least one agent is active
      COUNTIF(
      sea_status = 'active'
      OR coda_status = 'active'
      OR dma_status = 'active'
      OR asa_status = 'active'
      OR raca_status = 'active'
      ...
      linked_meta_app,
      linked_meta_app_id,
      -- Derive an overall status from the individual agent statuses
      CASE
      WHEN sea_status = 'active'
      OR coda_status = 'active'
      OR dma_status = 'active'
      OR asa_status = 'active'
      OR raca_status = 'active'
      ...
      -- Trial users with any Echo Me activity
      ...
      -- Join to echo_me_latest (INNER — only users who started a trial AND have Echo Me activity)
  ...
  dimension: overall_agent_status {
    ...
    description: "Status values: 'active' (at least one agent active), 'inactive' (no agents active)"
  }
  ...
  dimension: sea_status {
    ...
    description: "Status of the Social Engagement Agent"
  }
  ...
  dimension: coda_status {
    ...
    description: "Status of the Comment to DM Agent"
  }
  ...
  dimension: dma_status {
    ...
    description: "Status of the Deal Monitoring Agent"
  }
  ...
  dimension: asa_status {
    ...
    description: "Status of the Auto Selling Agent"
  }
  ...
  dimension: raca_status {
    ...
    description: "Status of the Real Estate Concierge Agent"
  }
  ...
  dimension: total_with_any_agent_active {
    ...
    description: "Number of echo_me_agents rows where at least one agent is active"
  }
  ...
  measure: total_unique_users {
    ...
    sql: ${TABLE}.user_id ;;
    label: "Unique Users"
    description: "Count of distinct users who set up an Echo Me agent"
    drill_fields: [drill_details*]
  }
  ...
  measure: total_active {
    ...
    description: "Users with at least one agent currently active"
    drill_fields: [drill_details*]
  }
  ...
  measure: total_inactive {
    ...
    description: "Users with no agents currently active"
    drill_fields: [drill_details*]
  }
  ...
  measure: sum_with_any_agent_active {
    ...
    description: "Sum of echo_me_agents rows with at least one active agent across users"
    drill_fields: [drill_details*]
  }
